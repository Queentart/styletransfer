...
STYLE_LOSS_WEIGHT = 1e-04 #바뀐 거
CONTENT_IMG_PATH = os.path.join('imgs', '01.jpg')
STYLE_IMG_PATH = os.path.join('imgs', 'rain_princess.jpg')
IMG_SIZE = 200
...
content_exts = [Extractor(model[i]) for i in [2, 5, 9, 12]]
...
style_exts = [Extractor(model[i]) for i in [2, 5, 9, 12, 16, 19, 22, 25, 29, 32, 35, 38, 42, 45, 48, 51]]
